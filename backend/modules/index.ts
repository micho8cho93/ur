...
const getOtherPlayerColor = (color: PlayerColor): PlayerColor => (color === "light" ? "dark" : "light");
...
const clearTurnTimer = (state: MatchState, reason: string | null = null): void => {
...
const resetTurnTimerForCurrentState = (state: MatchState, nowMs: number, reason: string): void => {
